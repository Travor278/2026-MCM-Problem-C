...
# Save results text
with open(os.path.join(Q3_DIR, "q3_sensitivity_summary.txt"), 'w') as f:
...
plt.tight_layout()
plt.savefig(os.path.join(Q3_DIR, "sensitivity_check_enhanced.png"), dpi=300, bbox_inches='tight')
plt.close()
